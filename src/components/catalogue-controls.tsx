  ...
  return (
    <div className="relative flex-1">
      ...
      <input
        ...
        // global outline painted here on every click. Brightening the border keeps a real,
        // AA-contrast focus signal without bringing that ring back.
        className="w-full rounded-lg border border-line bg-surface py-2.5 pr-11 pl-10 text-sm text-ink placeholder:text-ink-faint focus:border-ink-muted focus-visible:outline-none"
      />
      <button
        type="button"
        onClick={toggle}
